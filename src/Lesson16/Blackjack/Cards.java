...
public class Cards {
    ...
    public Cards(){
        ...
        Card card45 = new Card("Король крестовый", 10);
        Card card46 = new Card("Король бубновый", 10);
        Card card47 = new Card("Король червовый", 10);
        Card card48 = new Card("Король пиковый", 10);
